...
class WorkflowStep(Base):
    ...
    responsible_role = Column(Enum(WorkflowResponsibleRole, name="workflowresponsiblerole", create_type=False), nullable=False)
...
class CaseWorkflowProgress(Base):
    ...
    step_key = Column(String, nullable=False)
    status = Column(Enum(WorkflowStepStatus, name="workflowstepstatus", create_type=False), nullable=False, default=WorkflowStepStatus.pending)
...
class WorkflowOverride(Base):
    ...
    reason_category = Column(Enum(WorkflowOverrideCategory, name="workflowoverridecategory", create_type=False), nullable=False)
