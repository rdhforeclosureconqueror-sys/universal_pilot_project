...
workflow_responsible_role = sa.Enum("operator", "occupant", "system", "lender", name="workflowresponsiblerole")
workflow_step_status = sa.Enum("pending", "active", "blocked", "complete", name="workflowstepstatus")
